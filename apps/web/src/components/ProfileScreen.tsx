          ...
          <div className="mt-3 mx-4 bg-white/90 backdrop-blur-xl border border-gray-200/40 rounded-3xl shadow-lg p-6">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {user?.bio && <p className="text-sm text-gray-700 mb-3 line-clamp-2">{user.bio}</p>}
                    ...
                    {pets.map((pet, index) => (
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {pet.breed && <p className="text-sm text-gray-600 mb-1">{pet.breed}</p>}
                          {pet.bio && (
                ...
                <div className="px-4 py-6 border-b border-gray-100">
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Start tracking activities to earn badges!
                    </p>
                  </div>
                </div>
              </TabsContent>
