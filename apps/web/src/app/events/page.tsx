...
import { Plus, MapIcon, List, Loader2 } from "lucide-react"
import { eventsApi } from "@/lib/api"
import type { Event } from "@/lib/types"

// Fallback mock events data for when API fails
        ...
        {isLoading ? (
          ...
          <div className="px-4 py-6">
            <div className="text-center py-6 px-4 bg-muted/50 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground mb-4">Using cached data</p>
            </div>
            {view === "list" ? (
